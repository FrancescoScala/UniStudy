                ...
                <div class="row">
                    <div class="col-md-3">
                        <ul class="list-unstyled fs-5 sidebar">
                            <li><a class="active" href="<%=request.getContextPath()%>/amministratore/add_course.jsp">Aggiungi corso</a></li>
                            <li><a href="<%=request.getContextPath()%>/amministratore/delete_course.jsp">Rimuovi corso</a></li>
                        </ul>
                    </div>
                    <div class="col-md-9">
                        <div class="row">
