        ...
        <div class="row">
          <div class="col-md-3">
            <ul class="list-unstyled fs-5 sidebar">
              <li><a class="active" href="info-modify-course.html?id=<%=request.getParameter("id")%>">Modifica info corso</a></li>
              <li><a href="publish-alert.jsp?id=<%=request.getParameter("id")%>">Pubblica avviso</a></li>
