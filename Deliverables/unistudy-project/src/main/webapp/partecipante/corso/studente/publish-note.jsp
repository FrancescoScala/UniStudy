  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      function chiamaControl() {
        ...
        var jqxhr = $.post("<%=request.getContextPath()%>/NoteControl",
                {
                  "action": "add",
                  "id": $("#id").val(),
                  "title": $("#title").val(),
  ...
  <section class="portfolio-block hire-me">
    <div class="container">
      ...
      <form onsubmit="return false;">
        ...
        <div class="mb-3"><label class="form-label" for="title">Titolo</label><input class="form-control" name="title" type="text" id="title"></div>
        <div class="mb-3"><label class="form-label" for="description">Descrizione</label><textarea class="form-control" name="description" id="description"></textarea></div>
        <div class="mb-3">
          <div class="row">
            <div class="col-md-6 col-lg-12 col-xl-12 align-items-center button"><button id="createNoteButton" class="btn btn-primary d-block w-100" type="submit">Conferma</button></div>
          </div>
        </div>
      </form>
    </div>
